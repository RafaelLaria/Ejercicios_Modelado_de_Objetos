...
class Catedral(Edificio):
    def __init__(self, lugar, fecha_inicio, fecha_fin, fecha_BIC, material, estilo, nombre, culto, fecha_1consagracion, fecha_2inicio, fecha_2consagracion):
